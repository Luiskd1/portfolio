    ...
    <div>
      <div className="hidden lg:flex w-full border border-[#1E2D3D] h-12 space justify-between ">
        <div className="flex">
          ...
          <div className="flex">
            <Link className={pathname === '/' ? 'border-b-[#FEA55F] text-white size-5 w-32 xl:w-48 h-full font-medium border border-[#1E2D3D]  flex justify-center items-center  px-8 hover:text-white  ' : "  size-5 w-48 h-full font-medium border border-[#1E2D3D]  flex justify-center items-center  px-8 hover:text-white"} href='/' >
