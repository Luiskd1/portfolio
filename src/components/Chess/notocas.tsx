...
const Grid = styled.div`
  ...
  min-width: 60%; /* Ajusta el ancho del tablero */
...
const Cell = styled.div`
  ...
  background-image: ${(props) => {
    if (props.isSnake) {
      if (props.isHead) {
        // Imagen de la cabeza de la serpiente
        return `url(cabeza.png)`;
      } else if (props.isTail) {
        // Imagen de la cola de la serpiente
        return `url(cabeza.png)`;
      } else {
        // Imagen del cuerpo de la serpiente
        return `url(cabeza.png)`;
      }
    }
    return 'none';
