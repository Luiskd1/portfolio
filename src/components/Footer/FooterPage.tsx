...
const FooterPage = () => {
    ...
    return (
        <footer className="hidden sm:flex w-full border border-[#1E2D3D] h-12  justify-between  ">
            <div className="flex w-full">
                ...
                <div className="flex">
                    <Link className="flex border border-[#1E2D3D] w-16 justify-center items-center hover:border-b-2 hover:border-b-[#FEA55F] " href='https://github.com/Luiskd1' target="_blank">
                        <SiGithub size={30} />
                    </Link>
                    <Link className="flex border border-[#1E2D3D] w-16 justify-center items-center hover:border-b-2 hover:border-b-[#FEA55F]" href='https://www.linkedin.com/in/luis-pablo-santana-sampayo-5847b860/' target="_blank">
