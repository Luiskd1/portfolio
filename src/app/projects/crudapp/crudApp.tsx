  ...
  return (
    <div className=' flex flex-col gap-2 px-2 sm:px-16 w-full h-full'>
      <div className='flex items-center '>
        ...
        <Link href={"https://github.com/Luiskd1/Crud-final"} target="_blank" ><Button variant="link"><SiGithub size={25} />  <h1 className='text-1xl pl-4 text-[#8095AB]'>View in github</h1>
        </Button></Link>
      </div>
